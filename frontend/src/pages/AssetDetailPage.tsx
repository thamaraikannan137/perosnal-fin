      ...
      <MuiCard sx={{ p: 3 }}>
        <Stack spacing={2}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            ...
            <Chip
              label={selectedAsset.category === 'custom' && selectedAsset.customCategoryName 
                ? selectedAsset.customCategoryName 
          ...
          <Stack spacing={1.5}>
            ...
            {selectedAsset.category === 'custom' && selectedAsset.customFields && selectedAsset.customFields.length > 0 && (
              <>
                <Divider sx={{ my: 1 }}>
                  <Chip 
                    label="Custom Fields" 
                ...
                {selectedAsset.customFields.map((field) => (
                  <Box key={field.id}>
                    ...
                    <Typography variant="body1">
                      {field.type === 'currency' && field.value !== null
                        ? formatCurrency(Number(field.value))
                        : field.type === 'percentage' && field.value !== null
                        ? `${field.value}%`
                        ...
                        ? (
                          <Button
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            startIcon={<i className="ri-external-link-line" style={{ fontSize: '14px' }} />}
                        ...
                        ? (
                          <Button
                            ...
                            startIcon={<i className="ri-mail-line" style={{ fontSize: '14px' }} />}
                            sx={{ textTransform: 'none', p: 0, minWidth: 0 }}
                          >
                            {field.value}
                          </Button>
                        ...
                        ? (
                          <Button
                            ...
                            startIcon={<i className="ri-phone-line" style={{ fontSize: '14px' }} />}
                            sx={{ textTransform: 'none', p: 0, minWidth: 0 }}
                          >
                            {field.value}
                          </Button>
                        ...
                        ? String(field.value)
                        : <Typography variant="body2" color="text.secondary" component="span">Not specified</Typography>
                      }
                    </Typography>
                  </Box>
                ))}
